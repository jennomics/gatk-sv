...
workflow Module00c {
  ...
  if(!defined(bincov_matrix) || !defined(bincov_matrix_index)) {
  ...
  File merged_bincov_ = select_first([bincov_matrix, MakeBincovMatrix.merged_bincov])
  File merged_bincov_idx_ = select_first([bincov_matrix_index, MakeBincovMatrix.merged_bincov_idx])
